                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <select name="city" id="city_for_search"
                                    class="form-control f16 js-example-basic-single select2-hidden-accessible" required=""
                                    data-select2-id="city_for_search" tabindex="-1" aria-hidden="true">
                    ...
                    @foreach ($donor as $single)
                        <tr>
                            ...
                            <td>
                                ...
                                href="{{ route('bloodrequest', ['donor' => $single->id]) }}"
