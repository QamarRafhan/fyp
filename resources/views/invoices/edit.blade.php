                    ...
                    <form method="post" action="{{ route('invoice.store') }}" class="form-horizontal">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body invoice_items">
                                ...
                                <?php
                                $test = "  <div class='row single_item'><div class='col-4 border-tr p-0'> sss</div><div class='col border-tr p-0'>sss</div><div class='col border-tr p-0'>asdsad</div><div class='col border-tr p-0'> asdsad</div><div class='col border-tr p-0'> asdsad</div></div>";
                                ?>
        ...
        <div class="card-footer ml-auto mr-auto ">
            <div class="row">
                ...
                <div class="col-4  text-right">
                    <button type="submit" class="btn btn-primary">{{ $invoice->id ? __('Update') : __('Create') }}</button>
                </div>
