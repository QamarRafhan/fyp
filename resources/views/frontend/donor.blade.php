    ...
    <div class="col-md-12 " >
        <table id="" class="table table-striped table-bordered">
            ...
            <tbody style="color: black">
                <tr>
                    <td>1</td>
                    <td align="left" style="text-transform:capitalize!important;">QALAB E ABBAS</td>
                    <td>O+</td>
                    <td>Lahore</td>
                    <td>Lahore</td>
                    <td>
                        <a href="tel:092923145604355">
                            092923145604355 </a>
                    </td>
                    <td>
                        <a href="tel:">
                ...
                <tr>
                    <td>2</td>
                    <td align="left" style="text-transform:capitalize!important;">SHAHYAAR RANA</td>
                    <td>O+</td>
                    <td>Lahore</td>
                    <td>icchra</td>
                    <td>
                        <a href="tel:092923456656231">
                            092923456656231 </a>
                    </td>
                    <td>
                        <a href="tel:">
                ...
                <tr>
                    <td>3</td>
                    <td align="left" style="text-transform:capitalize!important;">zaheer</td>
                    <td>A+</td>
                    <td>Lahore</td>
                    <td>Gulberg</td>
                    <td>
                        <a href="tel:092923074538028">
                            092923074538028 </a>
                    </td>
                    <td>
                        <a href="tel:">
